  <template>
    <main class="w-full min-h-screen">
      ...
      <section class="w-full bg-linear-to-b from-background to-sidebar py-12 sm:py-16 md:py-20">
          ...
          <div class="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div class="space-y-6 sm:space-y-8 order-2 lg:order-1">
              ...
              <form @submit.prevent="handleSubmit" class="space-y-4 sm:space-y-6">
                ...
                <div>
                  <button type="submit" :disabled="isSubmitting"
                    ...
                    :class="{
                      ...
                      'bg-primary hover:shadow-lg hover:scale-105': !isSubmitting && !formResponse.success,
                    }">
                    <div v-if="isSubmitting" class="flex items-center justify-center gap-2">
                      <Icon name="lucide:loader-2" size="20" class="animate-spin" />
                      Sending...
                    </div>
                    <div v-else-if="formResponse.success" class="flex items-center justify-center gap-2">
                ...
                <div v-else-if="formResponse.error"
            ...
            <div class="space-y-6 sm:space-y-8 order-1 lg:order-2">
              ...
              <div class="space-y-3 sm:space-y-4">
                <a v-for="method in contactMethods" :key="method.title" :href="method.href"
                  ...
                  <div class="flex items-start gap-3 sm:gap-4">
                    ...
                    <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-300 shrink-0">
              ...
              <div class="p-4 sm:p-6 bg-chart-5/10 rounded-xl sm:rounded-2xl border border-chart-5/30">
                <div class="flex items-center gap-3 mb-2 sm:mb-3">
                  <div class="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-chart-5 rounded-full animate-pulse shrink-0"></div>
      ...
      <!-- FAQ Section -->
      <section class="w-full bg-linear-to-b from-sidebar to-background py-12 sm:py-16 md:py-20">
...
const { validateForm, register, errors, resetForm, handleSubmit } = useForm({
  ...
  onSubmit: async () => {
    ...
    try {
      ...
      formResponse.value = {
        success: false,
        error: error.data?.message || 'Failed to send message. Please try again.',
      }
    } finally {
      isSubmitting.value = false
    }
