  ...
  <main class="w-full min-h-screen bg-background text-foreground">
    ...
    <section
      ...
      <div class="absolute top-0 w-full h-full z-10">
        <ClientOnly>
          <BitsBackgroundsLightRays rays-origin="top-center"
            rays-color="oklch(from var(--color-foreground) l c h / 0.2)" :rays-speed="1.0" :light-spread="0.5"
            :ray-length="0.8" :follow-mouse="true" :mouse-influence="0.06" :noise-amount="0.15" :distortion="0.02"
      ...
      <div class="relative z-10 space-y-8">
        <div class="flex flex-col items-center justify-center text-center space-y-6">
          <h2
            class="font-poppins text-center text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-chart-1 via-chart-2 to-chart-3 bg-clip-text text-transparent p-3">
            My Projects
          </h2>

          <p class="font-inter text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A collection of projects I've worked on — from web apps to open-source tools, built with Astro, Svelte,
            Tauri, and more.
          </p>
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-8 mt-12">
          <div class="text-center">
            <div class="text-3xl font-bold bg-gradient-to-r from-chart-1 to-chart-3 bg-clip-text text-transparent">
              {{ projects.length }}+
            </div>
          ...
          <div class="text-center">
            <div class="text-3xl font-bold bg-gradient-to-r from-chart-4 to-chart-1 bg-clip-text text-transparent">
              6+
            </div>
            <div class="text-muted-foreground text-sm uppercase tracking-wide">
              Technologies
          ...
          <div class="text-center">
            <div class="text-3xl font-bold bg-gradient-to-r from-chart-5 to-chart-2 bg-clip-text text-transparent">
              2+
            </div>
            <div class="text-muted-foreground text-sm uppercase tracking-wide">
              Years Experience
      ...
      <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
        <div class="flex flex-col items-center animate-bounce">
          <span class="text-muted-foreground text-sm mb-2">Explore Projects</span>
    ...
    <section class="w-full py-20">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
          <h2
            class="text-4xl font-bold bg-gradient-to-r from-chart-1 via-chart-4 to-chart-3 bg-clip-text text-transparent mb-6">
            All Projects
          </h2>
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-12">
          <button v-for="category in categories" :key="category.id" @click="selectedCategory = category.id"
            class="px-6 py-3 rounded-xl font-medium transition-all duration-300" :class="[
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="project in filteredProjects" :key="project.id"
            ...
            <div class="relative h-48 bg-gradient-to-br from-muted to-card">
            ...
            <div class="p-6 flex flex-col h-full">
              <div class="flex-1 space-y-4">
                <h3 class="text-lg font-bold text-foreground group-hover:text-primary transition-colors duration-300">
                  {{ project.title }}
                </h3>
      ...
      <div class="max-w-4xl mx-auto text-center px-6">
        <div
          ...
          <p class="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
            I'm always excited to work on interesting projects and collaborate with passionate people. Let's bring your
            ideas to life!
          </p>
